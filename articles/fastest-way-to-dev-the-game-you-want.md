...
進捗としては、まえがきを読み終わって次は P.25 の目次です。目次の内容からおおよその学習を効率化させる方法を読み取って以下に書きます。

- 周囲の状況や文脈 一コンテキストー を必ず考慮に入れることが重要です
- ドレイファス兄弟の技能習得モデルの 5 段階における最高段階の達人を目指すためには、自分なりの経験を活用・応用 し、コンテキストを理解し、直感に頼ることが重要です
- 学習能力を高めるための具体的な手法として、計画を立てる、マインドマップ、読書法の SQ3R、教えることによって学ぶといった手法があります
...
これからストーリーを作るため、ストーリーが最も優先順位が高いです。ただ、映画を見るときに参考にしたいので、ストーリーより先に「カメラワーク・ライティング」をやります。

「アート（モデル）制作」については、現在開発中の作品では独自のモデルを作成しないため優先順位は低いですが、デザインスケッチを行った後に 3D モデリングに行くまでが長いので、早めに始めます。
また、「サウンド（ボイス）制作」についても現在開発中の作品ではボイスを入れないため、まだ優先順位は低いのですが、もし入れられるなら入れたいので早めに練習します。

ボイスとモデルは 30 分ずつ行う想定で、カメラワーク・ライティング（その後ストーリー）と隔日に行う想定です。

- カメラワーク・ライティング：紙で『映像クリエイターのための完全独学マニュアル』を読んで、ゲームづくりに役立てる点をスマホに書いてから本記事にまとめます。
- 脚本（ストーリー）の執筆：自分が好きなストーリーの傾向を過去の好きな作品の洗い出しによって把握し、作品を見て心を動かされた部分や考えたことをスマホにまとめてから映画のことを書く資料にまとめます（後でどこかで公開します）
